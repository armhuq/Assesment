...
public class TestData {
	...
	public static  String food_Path=startupPath+"\\src\\main\\resources\\food.html";
	public static  String dictionary_Path=startupPath+"\\src\\main\\resources\\dictionary.txt";
}
